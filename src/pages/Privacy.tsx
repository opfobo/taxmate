          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <div>
                ...
                <p className="mt-4 text-gray-300">{t("privacy_collection_text")}</p>
              </div>
              
              <div>
                <h2 className="text-2xl font-semibold">{t("privacy_use_title")}</h2>
                <p className="mt-4 text-gray-300">{t("privacy_use_text")}</p>
              ...
              <div>
                ...
                <p className="mt-4 text-gray-300">{t("privacy_cookies_text")}</p>
              </div>
              
              <div>
                <h2 className="text-2xl font-semibold">{t("privacy_sharing_title")}</h2>
                <p className="mt-4 text-gray-300">{t("privacy_sharing_text")}</p>
              </div>
              
              <div>
                <h2 className="text-2xl font-semibold">{t("privacy_security_title")}</h2>
                <p className="mt-4 text-gray-300">{t("privacy_security_text")}</p>
              </div>
              
              <div>
                <h2 className="text-2xl font-semibold">{t("privacy_changes_title")}</h2>
                <p className="mt-4 text-gray-300">{t("privacy_changes_text")}</p>
              </div>
              
              <div>
                <h2 className="text-2xl font-semibold">{t("privacy_contact_title")}</h2>
                <p className="mt-4 text-gray-300">{t("privacy_contact_text")}</p>
              </div>
            </div>
